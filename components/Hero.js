...
export default function Hero() {
  return (
    <div className='py-4 sm:py-12 flex flex-col gap-8 sm:gap-10 '>
      ...
      <p className='text-lg sm:text-xl md:text-2xl text-center w-full mx-auto max-w-[800px] '>Track your daily coding progress with <span className="font-semibold"> ease</span> and <span className="font-semibold"> simplicity</span></p>
      <CallToAction />
      <Calendar demo/>
    </div>
  )
